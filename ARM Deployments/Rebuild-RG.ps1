...
$JSONTemplateUri = "https://raw.githubusercontent.com/simontaggart/azure-templates/master/rg-dev-template.json"
# The Azure DevOps one is here: "https://dev.azure.com/ISGDevelopment/Data%20Warehouse/_apis/sourceProviders/TfsGit/filecontents?repository=Data%20Warehouse&commitOrBranch=master&path=%2FARM%2FInfrastructureBuild%2F${JSONTemplateFile}&api-version=5.0-preview.1"
...
Test-AzResourceGroupDeployment -ResourceGroupName $rgName -TemplateUri $JSONTemplateUri  -administratorLogin $adminUser -administratorLoginPassword $adminPassword -buildServerName $devSqlServer
